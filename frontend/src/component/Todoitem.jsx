...
function Todoitem(prop) {
  ...
  return (
    <div >
      <li className="ListIcon2">
        <div className="ListIcon3temp">
          {prop.index+". "}{dialogtext}
        </div>
        <div className="ListIcon4">
      ...
      <Dialog open={open}>
        <div style={{ height: 200, width: 500 }}>
          <input className="editInput" type="text" value={dialogtext} onChange={(e) => setdialogtext(e.target.value)} />
